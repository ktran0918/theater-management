...
<?php
    $msg = "Add new movie record to the movie table";
	...
	$queryIn = "SELECT * FROM movies where movie_ID = '$movie_ID'";
	    ...
	    $query = "INSERT INTO movies(movie_ID, movie_name, release_date, running_time, genre, rating, number_of_tickets_sold, price) VALUES('$movie_ID', '$movie_name', '$release_date', '$running_time', '$genre', '$rating', '$number_of_tickets_sold', '$price')";
